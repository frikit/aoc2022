...
fun main() {
    ...
    val totalSpace = result["/"]!!
    val freeSpace = 70000000L - totalSpace
    val needDelete = 30000000 - freeSpace

    println(result.entries.sortedBy { it.value }.first { it.value >= needDelete })
}
